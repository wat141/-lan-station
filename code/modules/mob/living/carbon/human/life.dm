...
#define HEAT_DAMAGE_LEVEL_3 20 		//Amount of damage applied when your body temperature passes the 460K point and you are on fire

#define COLD_DAMAGE_LEVEL_1 5 		//Amount of damage applied when your body temperature just passes the 260.15k safety point
#define COLD_DAMAGE_LEVEL_2 10 		//Amount of damage applied when your body temperature passes the 200K point
#define COLD_DAMAGE_LEVEL_3 20 		//Amount of damage applied when your body temperature passes the 120K point
...
#define HEAT_GAS_DAMAGE_LEVEL_2 10 	//Amount of damage applied when the current breath's temperature passes the 400K point
#define HEAT_GAS_DAMAGE_LEVEL_3 20 	//Amount of damage applied when the current breath's temperature passes the 1000K point
...
#define COLD_GAS_DAMAGE_LEVEL_2 10 	//Amount of damage applied when the current breath's temperature passes the 200K point
#define COLD_GAS_DAMAGE_LEVEL_3 20 	//Amount of damage applied when the current breath's temperature passes the 120K point

#define TINT_IMPAIR 2				//Threshold of tint level to apply weld mask overlay
#define TINT_BLIND 2				//Threshold of tint level to obscure vision fully
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
